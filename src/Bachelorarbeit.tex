...
%    \end{wrapfigure}
    ...
    \begin{description}[leftmargin=!,labelwidth=3cm]
        ...
        \item [expiry\_time] Ablaufdatum des Tokens. Gibt an wie lange der Token gültig ist.
    \end{description}

    Der eigentliche Registrierungsvorgang kann mehrere Autentifizierungsstufen enthalten.
    ...
    Im ersten Schritt sendet der Client eine leere Anfrage zum Server in welcher er um das starten einer Registrierungssitung bittet.
    ...
    Im nächsten Schritt sendet der Client dann den zuvor bereitgestellten Registrierungstoken und die vom server gegebene sessionid in Kombination mit der aktuellen Stufe des Authentifizierungs prozessen.
    ...
    \section{Start der Matrix Session}\label{sec:start-der-matrix-session}
