...
% Einbinden des Deckblatts
    ...
    Die Infrastrucktur soll isoliert laufen und nicht an das existierende Matrix-Netzwerk angeschlossen werden.
    ...
    Auerdem muss darauf geachtet werden, dass die Plattform keine der Vorschriften aus der DSGVO verletzt.
