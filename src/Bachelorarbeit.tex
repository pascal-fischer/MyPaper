...
% Einbinden des Deckblatts
    ...
    \chapter{Problembeschreibung und Motivation}\label{ch:problembeschreibung-und-motivation}
...
{"menu": {
  ...
  "popup": {
    ...
    \begin{enumerate}[label=\roman*.]
        ...
        \item Dem User kann ein typing-Indicator gezeigt werden.
        \item Die App kann auch mit anderen Homeservern verbunden werden.
        \item Der User kann den Inhalt einer Nachricht kopieren oder weiterleiten.
    \end{enumerate}
