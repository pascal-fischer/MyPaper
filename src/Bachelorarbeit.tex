...
% Einbinden des Deckblatts
    ...
    Zur Nutzung dieser ist die Implementierung einer Applikation (App) sowie die Bereitstellung der entsprechenden Infrastruktur notwendig.
    ...
    Außerdem ist darauf zu achten, dass die Plattform keine der Vorschriften aus der DSGVO verletzt.
...
target 'MyApp' do
  ...
  pod 'SwiftyJSON', '~> 2.3'
    ...
    Des Weiteren kann er den Port des Homeservers angeben.
