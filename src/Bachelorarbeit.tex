...
%    So sollte beispielsweise darauf geachtet werden, dass
    ...
    Der Elternknoten eines versendeten Events ist das zuletzt versendete Event eines Raumes.
...
%\end{figure}
    ...
    REST steht für REpresentational State Transfer und ist ein Architektur-Stil im Bereich verteilter Systeme.
    Es dient dem Datenaustausch zwischen einzelnen Systemen.
    Hierzu stellt beispielsweise ein Webservice verschiedene Ressourcen (Daten) zur Verfügung.
    Diese können über einen Uniform Resource Identifier (URI) adressiert werden.
    ...
    Auf diesen Ressourcen können dann eine Reihe zustandsloser Operationen ausgeführt werden.
